...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0" minimum-scale="1000px" />
  <title>Data Import</title>
  <script src="https://code.jquery.com/jquery-3.6.3.js" integrity="sha256-nQLuAZGRRcILA+6dMBOvcRh5Pe310sBpanc6+QBmyVM=" crossorigin="anonymous"></script>
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
  <link rel="stylesheet" href="./Css/index.css" />
  <link rel="stylesheet" href="./Css/listimport.css" />
  ...
  <div class="wrapper">
    <div class="nav-bar">
      ...
      <div class="menu-contact">
        <div class="menu-bar">
          <a class="menu-interact" href="index.php">
            <p>HOME</p>
          </a>
          <a class="menu-interact" href="?page=listimport">
            <p>YOUR IMPORT</p>
          </a>
          <a class="menu-interact" href="?page=import">
            <p>IMPORT</p>
          </a>
        </div>
